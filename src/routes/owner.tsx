...
import { Building2, LogOut, Plus, Settings as SettingsIcon, Pencil, Trash2, IndianRupee, History, CheckCircle2, XCircle, Loader2, Zap, MessageCircle, FileDown } from "lucide-react";
      ...
      <main className="max-w-5xl mx-auto px-4 pt-6 space-y-6">
        ...
        <Tabs defaultValue="flats">
          ...
          <TabsContent value="history" className="mt-4">
            <HistoryView flats={flats} readings={readings} settings={settings} onChange={refresh} />
          </TabsContent>
        </Tabs>
      </main>
...
function HistoryView({ flats, readings, settings, onChange }: { flats: Flat[]; readings: Reading[]; settings: Settings | null; onChange: () => void }) {
                ...
                <div className="text-right flex-shrink-0">
                  ...
                  <div className="flex gap-1 mt-2 justify-end">
                    ...
                    {r.payment_status === "paid" && (
                      <Button size="sm" variant="outline" className="h-7" onClick={() => exportReadingPdf({
                        reading: r,
